  ...
  <div>
    ...
    <div>
      ...
      <ul>
        ...
        <li>
          <p>4.刷新后BMap api is not loaded处理</p>
          使用promise异步创建一个标签加载外部库，然后条用函数
        </li>
      </ul>
    </div>
  </div>
...
export default {
  ...
  mounted() {
    this.promise_map('c1UeaC9cqD1MQNttQb7y5jNbH2GdV7Nj').then(BMap => {
      this.initEcharts()
    })
  },
  methods: {
