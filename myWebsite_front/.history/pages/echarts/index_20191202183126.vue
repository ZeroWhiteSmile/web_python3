...
require('../echarts/package/extension/bmap/BMapCoordSys')
require('../echarts/package/extension/bmap/BMapModel')
require('../echarts/package/extension/bmap/BMapView')
require('../echarts/package/extension/bmap/bmap')
export default {
  data () {
    return {
