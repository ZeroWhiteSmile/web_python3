<template>
  ...
  <baidu-map style="width:100%; height: 100%;"  :center="{lng: 104.114129, lat: 37.550339}" class="map" ak="c1UeaC9cqD1MQNttQb7y5jNbH2GdV7Nj" :scroll-wheel-zoom="true"></baidu-map>
  </div>
</template>
<!--百度地图 -->
